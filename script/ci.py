...
calib_l = load_yaml('/home/csc104/Projects/zed_ws/src/zed-ros-wrapper/script/left.yaml')
calib_r = load_yaml('/home/csc104/Projects/zed_ws/src/zed-ros-wrapper/script/right.yaml')
...
sub = Subscriber('/camera/left/image_rect_color', Image, cb)
